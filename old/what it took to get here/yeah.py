...
class MainApp(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.prices = [self.findChild(QLabel, f"price_{i}") for i in range(1, 70)]
    ...
    def save_item_1(self):
        with open("item1.txt", "w", encoding="utf-8") as file:    #Saves the item names from user input into
